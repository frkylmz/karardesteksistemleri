						...
						<div class="mail-box">
							<table class="mail-table">
								...
								<tr>
									...
									<td class="mail-clock"><a href="#">23 Aralık 2021<a></td>
								</tr>
								<tr>
									<td>
										<a href="#"><input type="checkbox" class="mail-checkbox"></a>
									...
									<td class="mail-clock"><a href="#">20 Aralık 2021<a></td>
								</tr>
								<tr class="read-mail">
									<td>
										<a href="#"><input type="checkbox" class="mail-checkbox1"></a>
									...
									<td class="mail-clock1"><a href="#">19 Kasım 2021<a></td>
								</tr>
								<tr class="read-mail">
									<td>
										<a href="#"><input type="checkbox" class="mail-checkbox1"></a>
									...
									<td class="mail-clock1"><a href="#">15 Kasım 2021<a></td>
								</tr>
								<tr class="read-mail">
									<td>
										<a href="#"><input type="checkbox" class="mail-checkbox1"></a>
									...
									<td class="mail-clock1"><a href="#">29 Ekim 2021<a></td>
								</tr>
							</table>
						</div>
					</div>
